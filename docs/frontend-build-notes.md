...
Operational detail for the cat-care frontend implementation effort — spec lookup and the multi-agent build workflow. Not part of the agent role definition itself.
